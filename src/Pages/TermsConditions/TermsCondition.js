    ...
    <div>
      ...
      <Paper className={classes.paperTwo}>
        ...
        <Typography className={classes.contentTypographys}>
          ...
          http://www.noqhub.com website as well as any other media form, media
        ...
        <Typography className={classes.contentTypographys}>
          ...
          of Use;(4) you are not under the age of 13; (5) you are not a minor in
          the jurisdiction in which you reside, or if a minor, you have received
          parental permission to use the Site; (6) you will not access the Site
        ...
        <Typography className={classes.contentTypographys}>
          ...
          rules set forthin the applicable App Distributor’s terms of service;
          (2) we areresponsible for providing any maintenance and support
        ...
        <Typography className={classes.contentTypographys}>
          ...
          Social Network Content may no aZlonger be available on and through the
          ...
          Third-Party Account and your contacts stored on your mobile device or
        ...
        <Typography className={classes.contentTypographys}>
          ...
          of Use. Please be advised the Site is hosted in Pakistan. If you
          ...
          that differ from applicable laws in Pakistan, then through your
          continued use of the Site, you are transferring your data to Pakistan,
        ...
        <Typography className={classes.contentTypographys}>
          ...
          be one (1). The seat, or legal place, of arbitration shall be Karachi,
        ...
        <Typography className={classes.contentTypographys}>
          ...
          OF THE AMOUNT PAID, IF ANY, BY YOU TO USDURING THE one (1) MONTH
          PERIOD PRIOR TO ANY CAUSE OF ACTION ARISINGOR $50.00 USD. CERTAIN US
