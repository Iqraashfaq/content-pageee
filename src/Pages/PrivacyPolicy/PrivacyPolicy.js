  ...
  return (
    <div>
      ...
      <Paper className={classes.paperTwo}>
        ...
        <h1 id="link-one">1. WHAT INFORMATION DO WE COLLECT?</h1>
        ...
        <Typography>
          ...
          collect phone numbers; names; email addresses; mailing addresses; job
          titles; usernames; passwords; contact preferences; billing addresses;
          debit/credit card numbers; contact or authentication data; and other
          similar information.
        </Typography>
        <Typography>
          ...
          stored by Foree. You may find their privacy notice link(s) here
          https://foree.co/privacy.
        </Typography>
        <Typography>
        ...
        <Typography>
          <strong>Information automatically collected</strong> <br /> <br />
          <em>
        ...
        <h2>Information collected through our App</h2>
        <em>
        ...
        <ul>
          ...
          <li>
            ...
            device's calendar, reminders, sensors, sms messages, social media
            accounts, storage, bluetooth, camera, and other features. If you
          ...
          <li>
            ...
            server). If you are using our App, we may also collect information
          ...
          <li>
            ...
            <br /> This information is primarily needed to maintain the security
        ...
        <h1 id="link-two">2. HOW DO WE USE YOUR INFORMATION?</h1>
        <Typography>
          <em>
            {" "}
            <strong>In Short:</strong>We process your information for purposes
            based on legitimate business interests, the fulfilment of our
        ...
        <ul>
          ...
          <li>
            ...
            testimonial, please contact us at support@noqhub.com and be sure to
        ...
        <h1 id="link-three">3. WILL YOUR INFORMATION BE SHARED WITH ANYONE?</h1>
        <Typography>
          <em>
        ...
        <ul>
          ...
          <li>
            ...
            where we believeit is necessary to investigate, prevent, or take
        ...
        <ul>
          ...
          <li>
            <strong>Google Maps Platform APIs.</strong>
            ...
            location-specific requests. This includes: User location; and other
            similar information. A full list of what we use information for can
            be found in this sectionand in the previous section titled "HOW DO
            WE USE YOUR INFORMATION?".We obtain and store on your device
            ('cache') your locationfor one (1) months. You may revoke your
            ...
            countries, Iceland, Liechtenstein and Norway) or United Kingdom,
            please take a look at our Cookie Notice.
          </li>
          <li>
            <strong>
              {" "}
        ...
        <h1 id="link-four">4. WHO WILL YOUR INFORMATION BE SHARED WITH? </h1>
        <Typography>
          <em>
        ...
        <h1 Link="link-six">6. HOW DO WE HANDLE YOUR SOCIAL LOGINS? </h1>
        <Typography>
          <em>
            <strong>In Short:</strong>In Short: If you choose to register or log
            in to our services using a social media account, we may have access
        ...
        <h1 id="link-seven">7. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</h1>
        <Typography>
          <em>
        ...
        <h1 id="link-eight">8. HOW LONG DO WE KEEP YOUR INFORMATION?</h1>
        <Typography>
          <em>
        ...
        <h1 id="link-nine">9. HOW DO WE KEEP YOUR INFORMATION SAFE?</h1>
        <Typography>
          <em>
        ...
        <h1 id="link-ten">10. WHAT ARE YOUR PRIVACY RIGHTS?</h1>
        <Typography>
          <em>
        ...
        <h1 id="link-eleven">11. CONTROLS FOR DO-NOT-TRACK FEATURES</h1>
        <Typography>
        ...
        <h1 id="link-thirteen">13. DO WE MAKE UPDATES TO THIS NOTICE? </h1>
        <Typography>
          <em>
